...
class Feature(commands.Cog):
    ...
    class Command(typing.Generic[GenericFeature, P, T]):  # pylint: disable=too-few-public-methods
        ...
        def __init__(self, parent: typing.Optional[str] = None, standalone_ok: bool = False, **kwargs: typing.Any):
            ...
            self.kwargs = kwargs
            self.callback: typing.Optional[typing.Callable[Concatenate[GenericFeature, ContextA, P], typing.Coroutine[typing.Any, typing.Any, T]]] = None
            self.depth: int = 0
    ...
    def __init__(self, *args: typing.Any, **kwargs: typing.Any):
        ...
        association_map: typing.Dict[Feature.Command["Feature", typing.Any, typing.Any], commands.Command["Feature", typing.Any, typing.Any]] = {}
