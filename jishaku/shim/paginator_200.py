...
def button_either_arg(a: MaybeButton[T], b: MaybeButton[T]) -> typing.Tuple[discord.Interaction, ui.Button[T]]:
    """
        ...
        class PageChangeModal(ui.Modal, title="Go to page"):
            ...
            async def on_submit(self, interaction: discord.Interaction):
                try:
                    ...
                    await interaction.response.send_message(content=f"``{self.page_number.value}`` could not be converted to a page number", ephemeral=True)
                else:
